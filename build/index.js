...
var ResponsiveImage = function (_React$Component) {
    ...
    _createClass(ResponsiveImage, [{
        ...
        value: function updateContainerDimensions() {
            ...
            var containerHeight = document.getElementById(id).offsetHeight;
        ...
        value: function render() {
            var _props = this.props,
                ...
                anchorX = _props.anchorX,
                anchorY = _props.anchorY;
            ...
            if (isLandscapeContainer && isLandscapeImage) {
                // Landscape container & image.
                // Calculate how wide the image would be if its height were exactly the same as the container.
                var testWidth = containerHeight * imageWidthToHeight;
                ...
                if (testWidth >= containerWidth) {
                    ...
                    var correctHeight = containerWidth * imageHeightToWidth;
                    resizedWidth = containerWidth;
                    resizedHeight = correctHeight;
                }
            } else if (!isLandscapeContainer && !isLandscapeImage) {
                ...
                var testHeight = containerWidth * imageHeightToWidth;
                ...
                if (testHeight >= containerHeight) {
                    ...
                    var correctWidth = containerHeight * imageWidthToHeight;
                ...
                var _correctWidth = containerHeight * imageWidthToHeight;
                resizedWidth = _correctWidth;
                resizedHeight = containerHeight;
            } else if (isLandscapeContainer && !isLandscapeImage) {
                ...
                var _correctHeight = containerWidth * imageHeightToWidth;
                resizedWidth = containerWidth;
                resizedHeight = _correctHeight;
            }
            ...
            if (anchorX) {
                ...
                var scaleFactor = resizedWidth / imageWidth;
                var resizedAnchorX = anchorX * scaleFactor;
                var deltaX = resizedAnchorX - centerX;
                ...
                if (deltaX > 0) {
                    ...
                    var horizontalSlack = resizedWidth - containerWidth;
            ...
            if (anchorY) {
                ...
                var _scaleFactor = resizedHeight / imageHeight;
                var resizedAnchorY = anchorY * _scaleFactor;
                var deltaY = resizedAnchorY - centerY;

                // The images defaults to a position that is as down as it can get.
                // So, the only offset we can make is to shift it up.
                if (deltaY > 0) {
                    // Figure out how much space we have to give.
                    var verticalSlack = resizedHeight - containerHeight;
                    // Offset while keeping the container filled.
